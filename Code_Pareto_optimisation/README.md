# Computational Workflow: Pareto Optimisation and Molecule Ranking

This project contains a computational workflow for prioritising small-molecule candidates using multi-objective optimisation. The workflow combines docking and pose-quality measures with physicochemical, ADMET and stereochemical properties to identify candidates for further investigation as protein-of-interest (POI) ligands in a potential PROTAC strategy.

## Background

This project evaluates computationally docked small-molecule candidates using a multi-objective optimisation approach. The workflow preserves trade-offs between different quality metrics rather than reducing all properties to a single score, and is designed to identify molecules suitable for further experimental investigation.
...
- reproducible binding poses across multiple crystal structures;
- ligand efficiency;
...
This project is part of a research collaboration. Please consult with the project supervisors regarding the appropriate license and usage restrictions.
...
The notebook was developed and tested with Python 3.8+.
